  ...
  return (
    <div className="w-full text-center">
      <div className="my-6">
        ...
        <button 
          className={`my-3 p-3 rounded-lg  text-white font-bold ${(colorPresent ||  maxItems) ? 'text-gray-500 bg-gray-200 pointer-events-none' : 'text-black bg-blue-900 hover:bg-blue-700 '}`} 
